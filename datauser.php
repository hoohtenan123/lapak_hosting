              ...
              <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    $no = 0;
                                    $query = mysqli_query($conn, "SELECT * FROM tbl_cu");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row['repassword'] ?>
                                        </td>
                                        <td>
                                            <?php if ($row['status']==0):?>
                                              <a class="btn btn-danger" href="status_user.php?s=0&id=<?php echo $row['no_hp']; ?>">Non Aktif</a>
                                            <?php elseif ($row['status']==1):?>
                                              <a class="btn btn-success" href="status_user.php?s=1&id=<?php echo $row['no_hp']; ?>">Aktif</a>
                                              <?php endif;?>
                                            
                                        </td>
                                        <td>
                                            <a class="btn btn-warning" href="edit_user.php?no_hp=<?php echo $row['no_hp']; ?>">Edit</a>
                                        
                                            <button type="button" class="btn btn-danger" data-toggle="modal"
                                                data-target="#modal-hapus<?php echo $row['username'] ?>">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="modal-hapus<?php echo $row['username'] ?>">
