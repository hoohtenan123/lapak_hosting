    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text pt-4">Hosting or web hosting is a place to store all website files and data so that many people can access it via the internet. 
            Website files and data can be in the form of videos, images, emails, scripts, applications, and databases.
            Without hosting, of course you can't make a website. That's why, you need to rent hosting first to create a website..</p>
        </div>
      </div>
    </div>
