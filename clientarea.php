...
<body>
  <nav class="navbar navbar-expand-lg bg-body">
    <div class="container">
      <a class="navbar-brand" href="clientarealog.php">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="clientarealog.php">Home</a>
            </li>
  ...
  <div class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      <div class="col">
        <div class="card">
          <a href="https://wa.me/6282288957205?text=Halo+admin+saya+mau+tanya+dong."><center><svg xmlns="http://www.w3.org/2000/svg" width="13%" height="50%" fill="currentColor" class="bi bi-headset my-3" viewBox="0 0 16 16">
