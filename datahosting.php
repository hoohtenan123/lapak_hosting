        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="datahosting.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Hosting</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Hosting</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="edit_hosting.php?ID_Hosting=<?php echo $row['ID_Hosting']; ?>">Edit</a>
                                       
                                            <button type="button" class="btn btn-danger" data-toggle="modal"
                                                data-target="#modal-hapus<?php echo $row['ID_Hosting'] ?>">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="modal-hapus<?php echo $row['ID_Hosting'] ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- form start -->
                                                    <form action="hapusdatahosting.php" method="post">
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Anda yakin ingin
                                                                    menghapus data ini? </label>
                                                                <input type="hidden" name="ID_Hosting"
                                                                    value="<?php echo $row['ID_Hosting'] ?>">
                                                                <input type="text" class="form-control" name="nama_paket"
                                                                    placeholder="Masukkan nama_paket"
  ...
  <div class="modal fade" id="modal-success">
        <div class="modal-dialog">
          <div class="modal-content bg-white">
            ...
            <div class="modal-body">
              <!-- form start -->
              <form action="tambahhosting.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputSocialMediaPromo">ID Hosting</label>
                    <input type="text" class="form-control" name="ID_Hosting" placeholder="ID Hosting" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputAfiliasi">Nama Paket</label>
                    <input type="text" class="form-control" name="nama_paket" placeholder="Nama Paket" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPengeluaran">Harga</label>
                    <input type="number" class="form-control" name="harga" placeholder="Harga" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPemasukan">Deskripsi</label>
                    <input type="text" class="form-control" name="deskripsi" placeholder="Deskripsi" required>
                  </div>
                    <div class="form-group">
                    <label for="exampleInputPemasukan">Storage</label>
                    <input type="text" class="form-control" name="storage" placeholder="Storage" required>
                  </div>
                    <div class="form-group">
                    <label for="exampleInputPemasukan">Type</label>
                    <input type="text" class="form-control" name="type" placeholder="Type" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPemasukan">Bandwidth</label>
                    <input type="text" class="form-control" name="bandwidth" placeholder="Bandwidth" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPemasukan">Support</label>
