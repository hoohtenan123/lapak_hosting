...
<body>
  ...
  <div class="card text-bg-primary mb-auto" style="max-width: 100%;">
    <div class="container"><br><br>
      <div class="card-header display-6 bg-primary">Security Guaranteed</div>
      <br><br>
    </div>
  </div>
  <div class="container mt-5 pt-5">
    <p class="text-center h5">Our Safety</p>
    <div class="h2 text-center text-uppercase">Security <span class="text-primary"><strong> Guarantee</strong></span></div></div>
