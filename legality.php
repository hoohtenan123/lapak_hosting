...
<body>
  ...
  <div class="card text-bg-primary mb-auto" style="max-width: 100%;">
    <div class="container"><br><br>
      <div class="card-header display-6 bg-primary">Legality</div>
        <br><br>
    </div>
  </div>
  <div class="container pt-5 mt-5 pb-4">
    <div class="h3 text-center text-uppercase py-1">Get To Know <br><span class="text-primary"><strong>Our Legality</strong></span></div>
